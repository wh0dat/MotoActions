...
class FlatDownStateMachine {
    private static final long FLATDOWN_DELAY = 500;
    private static final MALogger LOGGER = new MALogger(FlatDownStateMachine.class);
    private static final long NOT_STOWED_DELAY = 500;
    ...
    FlatDownStateMachine(ActionsSensorObserver actionsSensorObserver) {
    ...
    public void registerConditions() {
        ...
        this.mConditions.put(Conditions.LIFTING, new TimeDependentCondition(500));
        ...
        this.mConditions.put(Conditions.NOT_STOWED, new TimeDependentCondition(500));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x005b, code lost:
        if (r0 == com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Conditions.UNKNOWN) goto L_0x0076;
     */
    ...
    public synchronized void fireEvent(com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Event r4, boolean r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            ...
            com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Conditions r0 = com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Conditions.UNKNOWN     // Catch:{ Exception -> 0x006c }
            ...
            int[] r2 = com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.C05671.f40x256ba87b     // Catch:{ Exception -> 0x006c }
        ...
        L_0x0032:
            ...
            goto L_0x0054
        L_0x0035:
            com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Conditions r0 = com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Conditions.NOT_STOWED     // Catch:{ Exception -> 0x006c }
        ...
        L_0x003e:
            ...
            goto L_0x0059
        L_0x0040:
            com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Conditions r0 = com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Conditions.MOTION_LESS     // Catch:{ Exception -> 0x006c }
        ...
        L_0x0047:
            ...
            goto L_0x003e
        L_0x004a:
            com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Conditions r0 = com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Conditions.LIFTING     // Catch:{ Exception -> 0x006c }
        ...
        L_0x0059:
            com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Conditions r4 = com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.Conditions.UNKNOWN     // Catch:{ Exception -> 0x006c }
            if (r0 == r4) goto L_0x0076
            java.util.HashMap<com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Conditions, com.motorola.actions.lts.sensoraccess.LiftToSilenceConditions$Condition> r4 = r3.mConditions     // Catch:{ Exception -> 0x006c }
        ...
        L_0x0078:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.motorola.actions.lts.sensoraccess.FlatDownStateMachine.fireEvent(com.motorola.actions.lts.sensoraccess.FlatDownStateMachine$Event, boolean):void");
    }
    ...
    private void checkConditions() {
        ...
        if (z && this.mSensorObserver != null) {
            if (FlipToMuteService.isServiceEnabled()) {
                LOGGER.mo11957d("FTM enabled and phone flat down. LTS disabled for this case.");
            } else {

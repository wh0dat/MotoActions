...
public class ComponentBottomBarBorderAlignedTwoButtonsBinding extends ViewDataBinding {
    @Nullable
    ...
    static {
        sViewsWithIds.put(C0504R.C0506id.frame_right_button, 4);
    }

    public ComponentBottomBarBorderAlignedTwoButtonsBinding(@NonNull DataBindingComponent dataBindingComponent, @NonNull View view) {
        super(dataBindingComponent, view, 0);
        Object[] mapBindings = mapBindings(dataBindingComponent, view, 5, sIncludes, sViewsWithIds);
        this.frameLeftButton = (FrameLayout) mapBindings[1];
        this.frameLeftButton.setTag(null);
        this.frameRightButton = (FrameLayout) mapBindings[4];
        ...
        this.rightBtn = (Button) mapBindings[3];
    ...
    @NonNull
    public static ComponentBottomBarBorderAlignedTwoButtonsBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        return inflate(layoutInflater, viewGroup, z, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static ComponentBottomBarBorderAlignedTwoButtonsBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z, @Nullable DataBindingComponent dataBindingComponent) {
        return (ComponentBottomBarBorderAlignedTwoButtonsBinding) DataBindingUtil.inflate(layoutInflater, C0504R.layout.component_bottom_bar_border_aligned_two_buttons, viewGroup, z, dataBindingComponent);
    }

    @NonNull
    public static ComponentBottomBarBorderAlignedTwoButtonsBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static ComponentBottomBarBorderAlignedTwoButtonsBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable DataBindingComponent dataBindingComponent) {
        return bind(layoutInflater.inflate(C0504R.layout.component_bottom_bar_border_aligned_two_buttons, null, false), dataBindingComponent);
    }

    @NonNull
    public static ComponentBottomBarBorderAlignedTwoButtonsBinding bind(@NonNull View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static ComponentBottomBarBorderAlignedTwoButtonsBinding bind(@NonNull View view, @Nullable DataBindingComponent dataBindingComponent) {
        if ("layout/component_bottom_bar_border_aligned_two_buttons_0".equals(view.getTag())) {

...
public class SignInResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getResolveAccountResponse", mo9705id = 3)
    private final ResolveAccountResponse zzadu;
    @VersionField(mo9711id = 1)
    private final int zzal;
    @Field(getter = "getConnectionResult", mo9705id = 2)
    ...
    @Constructor
    SignInResponse(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) ConnectionResult connectionResult, @Param(mo9708id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zzal = i;

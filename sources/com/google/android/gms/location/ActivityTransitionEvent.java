...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @Field(getter = "getActivityType", mo9705id = 1)
    private final int zzi;
    @Field(getter = "getTransitionType", mo9705id = 2)
    private final int zzj;
    @Field(getter = "getElapsedRealTimeNanos", mo9705id = 3)
    private final long zzk;

    @Constructor
    public ActivityTransitionEvent(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) int i2, @Param(mo9708id = 3) long j) {

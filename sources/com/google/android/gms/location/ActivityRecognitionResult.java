...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    public ActivityRecognitionResult(@Param(mo9708id = 1) List<DetectedActivity> list, @Param(mo9708id = 2) long j, @Param(mo9708id = 3) long j2, @Param(mo9708id = 4) int i, @Param(mo9708id = 5) Bundle bundle) {
        boolean z = false;

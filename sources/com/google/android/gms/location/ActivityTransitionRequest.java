...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @Nullable
    @Field(getter = "getTag", mo9705id = 2)
    private final String tag;
    @Field(getter = "getActivityTransitions", mo9705id = 1)
    private final List<ActivityTransition> zzl;
    @Field(getter = "getClients", mo9705id = 3)
    ...
    @Constructor
    public ActivityTransitionRequest(@Param(mo9708id = 1) List<ActivityTransition> list, @Nullable @Param(mo9708id = 2) String str, @Nullable @Param(mo9708id = 3) List<ClientIdentity> list2) {

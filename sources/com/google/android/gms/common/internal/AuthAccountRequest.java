...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo9705id = 6, type = "android.accounts.Account")
    private Account zzs;

    @Constructor
    AuthAccountRequest(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) IBinder iBinder, @Param(mo9708id = 3) Scope[] scopeArr, @Param(mo9708id = 4) Integer num, @Param(mo9708id = 5) Integer num2, @Param(mo9708id = 6) Account account) {
        this.zzal = i;
        this.zzqv = iBinder;
        this.zzqw = scopeArr;
        this.zzqx = num;

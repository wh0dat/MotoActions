...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo9705id = 4)
    @Deprecated
    private final Scope[] zzqw;
    @Field(getter = "getButtonSize", mo9705id = 2)
    private final int zzux;
    @Field(getter = "getColorScheme", mo9705id = 3)
    private final int zzuy;

    @Constructor
    SignInButtonConfig(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) int i2, @Param(mo9708id = 3) int i3, @Param(mo9708id = 4) Scope[] scopeArr) {
        this.zzal = i;
        this.zzux = i2;
        this.zzuy = i3;
        this.zzqw = scopeArr;

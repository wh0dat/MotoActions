...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo9705id = 3)
    private ConnectionResult zzeu;
    @Field(getter = "getSaveDefaultAccount", mo9705id = 4)
    private boolean zzhs;
    @Field(mo9705id = 2)
    private IBinder zzqv;
    @Field(getter = "isFromCrossClientAuth", mo9705id = 5)
    ...
    @Constructor
    ResolveAccountResponse(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) IBinder iBinder, @Param(mo9708id = 3) ConnectionResult connectionResult, @Param(mo9708id = 4) boolean z, @Param(mo9708id = 5) boolean z2) {
        this.zzal = i;
        this.zzqv = iBinder;

...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo9705id = 2)
    private final int zzam;
    @Field(getter = "getResolution", mo9705id = 3)
    private final PendingIntent zzan;
    @Field(getter = "getErrorMessage", mo9705id = 4)
    ...
    @Constructor
    ConnectionResult(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) int i2, @Param(mo9708id = 3) PendingIntent pendingIntent, @Param(mo9708id = 4) String str) {
        this.zzal = i;
        this.zzam = i2;

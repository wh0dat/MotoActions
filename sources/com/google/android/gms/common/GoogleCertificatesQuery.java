...
public class GoogleCertificatesQuery extends AbstractSafeParcelable {
    ...
    @Field(getter = "getCallingPackage", mo9705id = 1)
    private final String zzbh;
    @Field(getter = "getCallingCertificateBinder", mo9705id = 2, type = "android.os.IBinder")
    @Nullable
    private final CertData zzbi;
    @Field(getter = "getAllowTestKeys", mo9705id = 3)
    private final boolean zzbj;

    @Constructor
    GoogleCertificatesQuery(@Param(mo9708id = 1) String str, @Param(mo9708id = 2) @Nullable IBinder iBinder, @Param(mo9708id = 3) boolean z) {
        this.zzbh = str;

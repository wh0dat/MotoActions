...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0496R.C0497drawable.common_full_open_on_phone, resources.getString(C0496R.string.common_open_on_phone), pendingIntent);
                } else {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, OnCancelListener onCancelListener) {
        return zza((Context) activity, i, DialogRedirect.getInstance(activity, getErrorResolutionIntent(activity, i, CommonCheckinAttributes.KEY_DAILY_ENABLE_SOURCE_TYPE_DEFAULT), i2), onCancelListener);
    }
    ...
    public GooglePlayServicesUpdatedReceiver registerCallbackOnUpdate(Context context, Callback callback) {
        ...
        intentFilter.addDataScheme(ModManager.EXTRA_PACKAGE);
    ...
    public boolean showErrorDialogFragment(Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i, int i2, OnCancelListener onCancelListener) {
        Dialog zza2 = zza((Context) activity, i, DialogRedirect.getInstance(lifecycleFragment, getErrorResolutionIntent(activity, i, CommonCheckinAttributes.KEY_DAILY_ENABLE_SOURCE_TYPE_DEFAULT), i2), onCancelListener);
        if (zza2 == null) {
            return false;
        }

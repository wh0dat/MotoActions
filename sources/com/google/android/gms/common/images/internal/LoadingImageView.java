...
public final class LoadingImageView extends ImageView {
    ...
    public LoadingImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zzqs = 0;
        this.zzqt = 1.0f;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0496R.styleable.LoadingImageView);
        this.zzqs = obtainStyledAttributes.getInt(C0496R.styleable.LoadingImageView_imageAspectRatioAdjust, 0);
        this.zzqt = obtainStyledAttributes.getFloat(C0496R.styleable.LoadingImageView_imageAspectRatio, 1.0f);
        setCircleCropEnabled(obtainStyledAttributes.getBoolean(C0496R.styleable.LoadingImageView_circleCrop, false));

...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, OnCancelListener onCancelListener) {
        ...
        Dialog zza = GoogleApiAvailability.zza((Context) activity, i, DialogRedirect.getInstance(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i, CommonCheckinAttributes.KEY_DAILY_ENABLE_SOURCE_TYPE_DEFAULT), i2), onCancelListener);
        if (zza == null) {
            return false;
        }

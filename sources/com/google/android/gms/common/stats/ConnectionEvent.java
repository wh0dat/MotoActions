...
public final class ConnectionEvent extends StatsEvent {
    ...
    @Field(getter = "getEventType", mo9705id = 12)
    private int zzxw;
    @Field(getter = "getCallingProcess", mo9705id = 4)
    private final String zzxx;
    @Field(getter = "getCallingService", mo9705id = 5)
    private final String zzxy;
    @Field(getter = "getTargetProcess", mo9705id = 6)
    private final String zzxz;
    @Field(getter = "getTargetService", mo9705id = 7)
    private final String zzya;
    @Field(getter = "getStackTrace", mo9705id = 8)
    private final String zzyb;
    @Field(getter = "getEventKey", mo9705id = 13)
    private final String zzyc;
    @Field(getter = "getElapsedRealtime", mo9705id = 10)
    private final long zzyd;
    @Field(getter = "getHeapAlloc", mo9705id = 11)
    private final long zzye;
    private long zzyf;

    @Constructor
    ConnectionEvent(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) long j, @Param(mo9708id = 12) int i2, @Param(mo9708id = 4) String str, @Param(mo9708id = 5) String str2, @Param(mo9708id = 6) String str3, @Param(mo9708id = 7) String str4, @Param(mo9708id = 8) String str5, @Param(mo9708id = 13) String str6, @Param(mo9708id = 10) long j2, @Param(mo9708id = 11) long j3) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzxx = str;

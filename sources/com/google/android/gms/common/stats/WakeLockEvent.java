...
public final class WakeLockEvent extends StatsEvent {
    ...
    @Field(getter = "getTimeout", mo9705id = 16)
    private final long mTimeout;
    @VersionField(mo9711id = 1)
    private final int zzal;
    @Field(getter = "getTimeMillis", mo9705id = 2)
    private final long zzxv;
    @Field(getter = "getEventType", mo9705id = 11)
    private int zzxw;
    @Field(getter = "getElapsedRealtime", mo9705id = 8)
    private final long zzyd;
    private long zzyf;
    @Field(getter = "getWakeLockName", mo9705id = 4)
    private final String zzyq;
    @Field(getter = "getSecondaryWakeLockName", mo9705id = 10)
    private final String zzyr;
    @Field(getter = "getCodePackage", mo9705id = 17)
    private final String zzys;
    @Field(getter = "getWakeLockType", mo9705id = 5)
    private final int zzyt;
    @Field(getter = "getCallingPackages", mo9705id = 6)
    private final List<String> zzyu;
    @Field(getter = "getEventKey", mo9705id = 12)
    private final String zzyv;
    @Field(getter = "getDeviceState", mo9705id = 14)
    private int zzyw;
    @Field(getter = "getHostPackage", mo9705id = 13)
    private final String zzyx;
    @Field(getter = "getBeginPowerPercentage", mo9705id = 15)
    private final float zzyy;

    @Constructor
    WakeLockEvent(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) long j, @Param(mo9708id = 11) int i2, @Param(mo9708id = 4) String str, @Param(mo9708id = 5) int i3, @Param(mo9708id = 6) List<String> list, @Param(mo9708id = 12) String str2, @Param(mo9708id = 8) long j2, @Param(mo9708id = 14) int i4, @Param(mo9708id = 10) String str3, @Param(mo9708id = 13) String str4, @Param(mo9708id = 15) float f, @Param(mo9708id = 16) long j3, @Param(mo9708id = 17) String str5) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzyq = str;

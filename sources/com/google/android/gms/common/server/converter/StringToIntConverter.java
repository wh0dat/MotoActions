...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    @Field(getter = "getSerializedMap", mo9705id = 2)
    ...
    public static final class Entry extends AbstractSafeParcelable {
        ...
        @Constructor
        Entry(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) String str, @Param(mo9708id = 3) int i2) {
            this.versionCode = i;
            this.zzwh = str;
            this.zzwi = i2;
        }
    ...
    @Constructor
    StringToIntConverter(@Param(mo9708id = 1) int i, @Param(mo9708id = 2) ArrayList<Entry> arrayList) {
        this.zzal = i;
        this.zzwe = new HashMap<>();
        this.zzwf = new SparseArray<>();
        this.zzwg = null;

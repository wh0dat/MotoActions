...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo9705id = 1)
    private final int zzam;
    @Nullable
    @Field(getter = "getPendingIntent", mo9705id = 3)
    private final PendingIntent zzan;
    @Nullable
    @Field(getter = "getStatusMessage", mo9705id = 2)
    ...
    @Constructor
    @KeepForSdk
    Status(@Param(mo9708id = 1000) int i, @Param(mo9708id = 1) int i2, @Nullable @Param(mo9708id = 2) String str, @Nullable @Param(mo9708id = 3) PendingIntent pendingIntent) {
        this.zzal = i;
        this.zzam = i2;
        this.zzao = str;

...
final class zzf implements Runnable {
    ...
    public final void run() {
        try {
            ...
            task.addOnSuccessListener(TaskExecutors.zzagd, (OnSuccessListener<? super TResult>) this.zzafp);
            task.addOnFailureListener(TaskExecutors.zzagd, (OnFailureListener) this.zzafp);
            task.addOnCanceledListener(TaskExecutors.zzagd, (OnCanceledListener) this.zzafp);

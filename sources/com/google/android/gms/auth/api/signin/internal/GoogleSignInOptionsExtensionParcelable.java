...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @Field(getter = "getBundle", mo9705id = 3)
    private Bundle mBundle;
    @VersionField(mo9711id = 1)
    private final int versionCode;
    @Field(getter = "getType", mo9705id = 2)
    private int zzac;

    @Constructor
    GoogleSignInOptionsExtensionParcelable(@Param(mo9708id = 1) int i, @TypeId @Param(mo9708id = 2) int i2, @Param(mo9708id = 3) Bundle bundle) {
        this.versionCode = i;
        this.zzac = i2;
        this.mBundle = bundle;
    }

...
public final class FlowableTakeUntilPredicate<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class InnerSubscriber<T> implements Subscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f332s, subscription)) {
                this.f332s = subscription;
    ...
    public FlowableTakeUntilPredicate(Publisher<T> publisher, Predicate<? super T> predicate2) {
        super(publisher);
        this.predicate = predicate2;
    }

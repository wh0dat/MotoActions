...
public final class FlowableSkipLastTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class SkipLastTimedSubscriber<T> extends AtomicInteger implements Subscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f323s, subscription)) {
                this.f323s = subscription;
    ...
    public FlowableSkipLastTimed(Publisher<T> publisher, long j, TimeUnit timeUnit, Scheduler scheduler2, int i, boolean z) {
        super(publisher);
        this.time = j;
        this.unit = timeUnit;
        this.scheduler = scheduler2;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        publisher.subscribe(skipLastTimedSubscriber);
    }
}

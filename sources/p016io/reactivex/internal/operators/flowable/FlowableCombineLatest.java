...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        public void innerComplete(int r3) {
            ...
            L_0x001c:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p016io.reactivex.internal.operators.flowable.FlowableCombineLatest.CombineLatestCoordinator.innerComplete(int):void");
        }
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        ...
        if (i == 0) {
            ...
            new FlowableMap(publisherArr[0], new Function<T, R>() {

...
public final class FlowableTakeLastTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class TakeLastTimedSubscriber<T> extends AtomicInteger implements Subscriber<T>, Subscription {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f330s, subscription)) {
                this.f330s = subscription;
    ...
    public FlowableTakeLastTimed(Publisher<T> publisher, long j, long j2, TimeUnit timeUnit, Scheduler scheduler2, int i, boolean z) {
        super(publisher);
        this.count = j;
        this.time = j2;
        this.unit = timeUnit;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        publisher.subscribe(takeLastTimedSubscriber);
    }
}

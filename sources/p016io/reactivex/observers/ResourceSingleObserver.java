...
public abstract class ResourceSingleObserver<T> implements SingleObserver<T>, Disposable {
    ...
    /* renamed from: s */
    private final AtomicReference<Disposable> f562s = new AtomicReference<>();
    ...
    public final void onSubscribe(Disposable disposable) {
        if (DisposableHelper.setOnce(this.f562s, disposable)) {
            onStart();
        }
    }

    public final void dispose() {
        if (DisposableHelper.dispose(this.f562s)) {
            this.resources.dispose();
        }
    }

    public final boolean isDisposed() {
        return DisposableHelper.isDisposed((Disposable) this.f562s.get());
    }
}

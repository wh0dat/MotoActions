...
final class SerializedSubject<T> extends Subject<T> implements NonThrowingPredicate<Object> {
    ...
    public void onError(java.lang.Throwable r3) {
        ...
        L_0x002e:
            ...
            return
        L_0x0035:
            io.reactivex.subjects.Subject<T> r2 = r2.actual
            r2.onError(r3)
            return
        L_0x003b:
            r3 = move-exception
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p016io.reactivex.subjects.SerializedSubject.onError(java.lang.Throwable):void");
    }

...
final class SerializedProcessor<T> extends FlowableProcessor<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0031, code lost:
        p016io.reactivex.plugins.RxJavaPlugins.onError(r3);
     */
    ...
    public void onError(java.lang.Throwable r3) {
        ...
        L_0x0022:
            java.lang.Object r3 = p016io.reactivex.internal.util.NotificationLite.error(r3)     // Catch:{ all -> 0x003b }
        ...
        L_0x002e:
            ...
            return
        L_0x0035:
            io.reactivex.processors.FlowableProcessor<T> r2 = r2.actual
            r2.onError(r3)
            return
        L_0x003b:
            r3 = move-exception
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p016io.reactivex.processors.SerializedProcessor.onError(java.lang.Throwable):void");
    }

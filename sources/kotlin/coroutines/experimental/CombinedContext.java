...
public final class CombinedContext implements CoroutineContext {
    ...
    public CombinedContext(@NotNull CoroutineContext coroutineContext, @NotNull Element element2) {
        Intrinsics.checkParameterIsNotNull(coroutineContext, MicroScreenService.SCREEN_POSITION_LEFT);

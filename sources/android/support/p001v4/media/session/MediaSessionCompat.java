        ...
        private class StubApi21 implements Callback {
            ...
            public void onCommand(java.lang.String r3, android.os.Bundle r4, android.os.ResultReceiver r5) {
                /*
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r2 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e7 }
                    java.lang.ref.WeakReference r2 = r2.mSessionImpl     // Catch:{ BadParcelableException -> 0x00e7 }
                    java.lang.Object r2 = r2.get()     // Catch:{ BadParcelableException -> 0x00e7 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r2 = (android.support.p001v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r2     // Catch:{ BadParcelableException -> 0x00e7 }
                    if (r2 == 0) goto L_0x00ee
                    android.os.Bundle r3 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00e7 }
                    r3.<init>()     // Catch:{ BadParcelableException -> 0x00e7 }
                    android.support.v4.media.session.MediaSessionCompat$Token r2 = r2.getSessionToken()     // Catch:{ BadParcelableException -> 0x00e7 }
                    android.support.v4.media.session.IMediaSession r2 = r2.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00e7 }
                    java.lang.String r4 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r2 != 0) goto L_0x0029
                    goto L_0x002d
                L_0x0029:
                    android.os.IBinder r1 = r2.asBinder()     // Catch:{ BadParcelableException -> 0x00e7 }
                L_0x002d:
                    android.support.p001v4.app.BundleCompat.putBinder(r3, r4, r1)     // Catch:{ BadParcelableException -> 0x00e7 }
                    r2 = 0
                    r5.send(r2, r3)     // Catch:{ BadParcelableException -> 0x00e7 }
                    goto L_0x00ee
                L_0x0036:
                    ...
                    android.os.Parcelable r3 = r4.getParcelable(r3)     // Catch:{ BadParcelableException -> 0x00e7 }
                    android.support.v4.media.MediaDescriptionCompat r3 = (android.support.p001v4.media.MediaDescriptionCompat) r3     // Catch:{ BadParcelableException -> 0x00e7 }
                    r2.onAddQueueItem(r3)     // Catch:{ BadParcelableException -> 0x00e7 }
                    goto L_0x00ee
                L_0x0056:
                    ...
                    int r4 = r4.getInt(r5)     // Catch:{ BadParcelableException -> 0x00e7 }
                    r2.onAddQueueItem(r3, r4)     // Catch:{ BadParcelableException -> 0x00e7 }
                    goto L_0x00ee
                L_0x007c:
                    ...
                    android.os.Parcelable r3 = r4.getParcelable(r3)     // Catch:{ BadParcelableException -> 0x00e7 }
                    android.support.v4.media.MediaDescriptionCompat r3 = (android.support.p001v4.media.MediaDescriptionCompat) r3     // Catch:{ BadParcelableException -> 0x00e7 }
                    r2.onRemoveQueueItem(r3)     // Catch:{ BadParcelableException -> 0x00e7 }
                    goto L_0x00ee
                L_0x009b:
                ...
                L_0x00d5:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r2 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e7 }
                    android.support.v4.media.MediaDescriptionCompat r3 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00e7 }
                    r2.onRemoveQueueItem(r3)     // Catch:{ BadParcelableException -> 0x00e7 }
                    goto L_0x00ee
                L_0x00e1:
                    android.support.v4.media.session.MediaSessionCompat$Callback r2 = android.support.p001v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e7 }
                    r2.onCommand(r3, r4, r5)     // Catch:{ BadParcelableException -> 0x00e7 }
                    goto L_0x00ee
                L_0x00e7:

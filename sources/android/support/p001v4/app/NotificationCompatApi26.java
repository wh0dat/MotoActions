...
class NotificationCompatApi26 {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        ...
        /* renamed from: mB */
        private android.app.Notification.Builder f11mB;
        ...
        Builder(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, boolean z3, int i4, CharSequence charSequence4, boolean z4, String str, ArrayList<String> arrayList, Bundle bundle, int i5, int i6, Notification notification2, String str2, boolean z5, String str3, CharSequence[] charSequenceArr, RemoteViews remoteViews2, RemoteViews remoteViews3, RemoteViews remoteViews4, String str4, int i7, String str5, long j, boolean z6, boolean z7, int i8) {
            ...
            this.f11mB = deleteIntent.setFullScreenIntent(pendingIntent3, z8).setLargeIcon(bitmap).setNumber(i).setUsesChronometer(z3).setPriority(i4).setProgress(i2, i3, z).setLocalOnly(z4).setExtras(bundle).setGroup(str2).setGroupSummary(z5).setSortKey(str3).setCategory(str).setColor(i5).setVisibility(i6).setPublicVersion(notification2).setRemoteInputHistory(charSequenceArr).setChannelId(str6).setBadgeIconType(i7).setShortcutId(str5).setTimeoutAfter(j).setGroupAlertBehavior(i8);
            if (z7) {
                this.f11mB.setColorized(z6);
            }
            if (remoteViews5 != null) {
                this.f11mB.setCustomContentView(remoteViews5);
            }
            if (remoteViews6 != null) {
                this.f11mB.setCustomBigContentView(remoteViews6);
            }
            if (remoteViews7 != null) {
                this.f11mB.setCustomHeadsUpContentView(remoteViews7);
            }
            Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                this.f11mB.addPerson((String) it.next());
            }
        }

        public void addAction(Action action) {
            NotificationCompatApi24.addAction(this.f11mB, action);
        }

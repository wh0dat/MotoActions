...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0383R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0383R.styleable.ActionBarLayout_android_layout_gravity, 0);

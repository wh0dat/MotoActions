...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    public static abstract class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0386R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas2, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f32mX, recoverAnimation.f33mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas2.save();
                onChildDrawOver(canvas2, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f32mX, recoverAnimation.f33mY, recoverAnimation.mActionState, false);
                canvas2.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas2.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        public void update() {
            if (this.mStartDx == this.mTargetX) {
                ...
                this.f32mX = this.mStartDx + (this.mFraction * (this.mTargetX - this.mStartDx));
            }
            if (this.mStartDy == this.mTargetY) {
                this.f33mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f33mY = this.mStartDy + (this.mFraction * (this.mTargetY - this.mStartDy));
            }
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0386R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0386R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    public void select(android.support.p004v7.widget.RecyclerView.ViewHolder r25, int r26) {
        /*
            r24 = this;
            r11 = r24
            r12 = r25

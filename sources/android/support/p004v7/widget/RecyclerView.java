...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0386R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0386R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0386R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0386R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0386R.styleable.RecyclerView_stackFromEnd, false);
    ...
    public final class Recycler {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public android.support.p004v7.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r18, boolean r19, long r20) {
            /*
                r17 = this;
                r6 = r17
                r3 = r18
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0386R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0386R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0386R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0386R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0386R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0386R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0386R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0386R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    private void pullGlows(float r7, float r8, float r9, float r10) {
        /*
            ...
            float r9 = r9 / r5
            float r9 = r2 - r9
            android.support.p001v4.widget.EdgeEffectCompat.onPull(r1, r4, r9)
        L_0x001f:
            r9 = r3
            goto L_0x003c
        L_0x0021:
        ...
        L_0x003c:
            ...
            float r2 = (float) r2
            float r7 = r7 / r2
            android.support.p001v4.widget.EdgeEffectCompat.onPull(r9, r1, r7)
            goto L_0x0072
        L_0x0056:
            int r1 = (r10 > r0 ? 1 : (r10 == r0 ? 0 : -1))
            ...
            float r7 = r7 / r4
            float r2 = r2 - r7
            android.support.p001v4.widget.EdgeEffectCompat.onPull(r9, r1, r2)
            goto L_0x0072
        L_0x0071:
            r3 = r9
        L_0x0072:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00af, code lost:
        if (r6.isFocusable() != false) goto L_0x00b3;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0386R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0386R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0386R.dimen.fastscroll_margin));
    }

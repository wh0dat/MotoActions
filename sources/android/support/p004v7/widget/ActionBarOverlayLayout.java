...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0383R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0383R.C0385id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0383R.C0385id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0383R.C0385id.action_bar));
        }
    }

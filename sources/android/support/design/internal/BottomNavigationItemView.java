...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0067R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0067R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(C0067R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0067R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0067R.C0068drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0067R.C0069id.icon);
        this.mSmallLabel = (TextView) findViewById(C0067R.C0069id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0067R.C0069id.largeLabel);
    }

...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0067R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C0067R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0067R.styleable.SnackbarLayout_elevation, 0));
            }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0067R.layout.design_layout_snackbar, this.mTargetParent, false);
    ...
    public void animateViewIn() {
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0067R.anim.design_snackbar_in);
    ...
    private void animateViewOut(final int i) {
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0067R.anim.design_snackbar_out);
        loadAnimation.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        loadAnimation.setDuration(250);
        loadAnimation.setAnimationListener(new AnimationListener() {
            public void onAnimationRepeat(Animation animation) {

...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        @FloatRange(from = 0.0d, mo536to = 1.0d)
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0067R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0067R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0067R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0067R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0067R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0067R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0067R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0067R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0067R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0067R.styleable.CoordinatorLayout, i, C0067R.style.Widget_Design_CoordinatorLayout);
        int resourceId = obtainStyledAttributes.getResourceId(C0067R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0067R.styleable.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        setupForInsets();
    ...
    public void onMeasure(int r32, int r33) {
        /*
            ...
            int r10 = android.support.p001v4.view.ViewCompat.getLayoutDirection(r31)
            r2 = 1
        ...
        L_0x0022:
            ...
            boolean r3 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r31)
            if (r3 == 0) goto L_0x004b
            r19 = r2
            goto L_0x004d
        L_0x004b:
        ...
        L_0x0072:
            ...
            int r2 = android.support.p001v4.view.GravityCompat.getAbsoluteGravity(r2, r10)
            r2 = r2 & 7
            r22 = r3
            r3 = 3
        ...
        L_0x00c4:
            ...
            boolean r0 = android.support.p001v4.view.ViewCompat.getFitsSystemWindows(r1)

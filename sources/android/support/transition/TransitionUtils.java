...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(MeasureSpec.makeMeasureSpec(round3 - round, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(round4 - round2, ErrorDialogData.SUPPRESSED));
